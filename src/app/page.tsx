...
import IntentExplorerPanel from '@/components/IntentExplorerPanel';

type RightPanelTab = 'assist' | 'intent' | 'guitar' | 'variants' | 'versions';
type MobileToolTab = 'metrics' | 'assist' | 'intent' | 'guitar' | 'variants' | 'versions';
...
export default function Home() {
  ...
  const renderMobileSheetContent = () => {
    switch (mobileSheet) {
      ...
      case 'intent':
        return <IntentExplorerPanel onInsert={handleInsert} />;
      case 'guitar':
        return <GuitarPanel />;
      case 'variants':
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-gray-100">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="hidden lg:flex w-80 bg-white overflow-hidden flex-col">
          <div className="border-b border-gray-200 p-2 flex gap-2">
            ...
            <button onClick={() => setRightPanelTab('intent')} className={`text-xs font-medium px-3 py-1 rounded transition ${rightPanelTab === 'intent' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-100'}`}>Téma</button>
          ...
          <div className="flex-1 overflow-hidden">
            ...
            {rightPanelTab === 'intent' && <IntentExplorerPanel onInsert={handleInsert} />}
      ...
      <div className="lg:hidden bg-white border-t border-gray-200 px-2 py-2 flex justify-between gap-1 sticky bottom-0">
        ...
        <button onClick={() => setMobileSheet('intent')} className="flex-1 py-2 px-2 text-xs font-medium rounded transition bg-indigo-100 hover:bg-indigo-200 text-indigo-700">🧭 Téma</button>
